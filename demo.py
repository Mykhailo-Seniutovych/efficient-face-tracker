...
from face_tracker import FaceTracker, Config, draw_bbox, blur_and_draw
...
face_tracker = FaceTracker(config, frames_reader, frames_writer, on_frame_detected_action=draw_bbox)
